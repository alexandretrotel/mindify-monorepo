        ...
        <div className="flex flex-col gap-8">
          ...
          <div>
            <TypographySpan isDefaultColor>
              ...
              consectetur lacinia. Integer sit amet nisl nec nisi ultricies ultricies. Nam sodales,
              nunc eget ultricies luctus, orci nunc ultricies metus, in ultricies justo justo ac
              nunc. Nullam nec dui nec nunc consectetur lacinia. Integer sit amet nisl nec nisi
              ultricies ultricies. Nam sodales, nunc eget ultricies luctus, orci nunc ultricies
              metus, in ultricies justo justo ac nunc.
            </TypographySpan>
          </div>
        </div>
      </div>
